...
// Чесно кажучи, я не знаю, як вирішити це завдання, якщо порядок оголошення переміннич саме damin, а лише потім name. Потрібна допомога, pleaase!
var admin = name;
var name = "Bill Gates";
console.log(admin)

var name = "Bill Gates"; //так було б занадто просто
var admin = name;
console.log(admin)
// а можна й так, але не в цьому завданні
var admin = {
    name : "Bill Gates"
}
